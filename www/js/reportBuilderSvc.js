...
(function() {
	...
	function reportBuilderService($rootScope) {
        ...
        function _generateReport() {		
			...
			/*
			var externalDataRetrievedFromServer = [
				{ 'name': 'Bartek', 'age': '34' , 'total': '1000' },
				{ name: 'John', age: 27, total: 1000 },
				{ name: 'Elizabeth', age: 30, total: 1000 },
			...
			return { content: [
				table(externalDataRetrievedFromServer, ['product_no','productname','itemQnt','unit_price']),
				{
				...
				/*{
						style: 'tableExample',
							table: {
								...
								body: [
										[ 'Product No',bold:true}, {text:'Product Name',bold:true}, {text:'Quantity',bold:true}, {text:'List Price',bold:true},{text:'Discount',bold:true},{text:'Total',bold:true}],
